...
?>
<div class="Info">
   <?php echo T('使用户可以使用QQ登录', '使用户可以使用QQ登录 <b>你需要在腾讯开放平台注册才能使用</b>'); ?>
</div>
<div class="Configuration">
   <div class="ConfigurationForm">
      <ul>
         <li>
            <?php
               echo $this->Form->Label('App ID', 'AppKey');
               echo $this->Form->TextBox('AppKey');
            ?>
         </li>
         <li>
            <?php
               echo $this->Form->Label('Key', 'Secret');
   ...
   <div class="ConfigurationHelp">
      <strong>获取AppId和AppKey的方式</strong>
      <p>将你的网站在<a href="http://connect.qq.com/" target="_blank">http://connect.qq.com/</a>注册</p>
      <p>获取到AppID和Key后点击保存</p>
   </div>
</div>   
<?php
